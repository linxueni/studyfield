...
import com.lxn.test.App_data;
import com.lxn.test.Collect;
import com.lxn.test.Hold;
import com.lxn.test.R;
...
public class MyuseAdapter extends SimpleAdapter {
    //上下文
    Context context;
    String TAG="first";
    String tag1;
    String tag2;
    String content;
    public MyuseAdapter(Context context,
